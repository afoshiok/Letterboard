...
#Finding year with the most logged films
...
#Finding the oldest film logged
...
#DF of Production Countries (Same method for Genres)
...
#Finding top directors (Same method for writers)
